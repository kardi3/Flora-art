...
$upload_dir = '/media/elfinder/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../media/elfinder/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../media/elfinder/'; // relative path from filemanager folder to thumbs folder (with final /)
 ...
 */
$fixed_image_creation_option            = array('crop',false); //set the type of the crop
