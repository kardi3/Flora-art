...
var yadcf = (function ($) {
	...
	function doFilter(arg, table_selector_jq_friendly, column_number, filter_match_mode) {
		...
		if (arg === "clear") {
                    var option_text = $("#yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + " option[value='-1']").text();
                    console.log(option_text);
                    $("#yadcf-filter-" + table_selector_jq_friendly + "-" + column_number).prev("span").text(option_text); 
						...
						if (column_data_type === "html") {
							...
							for (k = 0; k < col_inner_elements.length; k++) {
								...
								case "id":
									...
									break;
                                                                case "span_value":
                                                                        col_inner_data = $(col_inner_elements[0]).last('span').text()
                                                                        break;
								}
