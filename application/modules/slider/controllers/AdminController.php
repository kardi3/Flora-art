...
class Slider_AdminController extends MF_Controller_Action {
            ...
            foreach($href as $h) {
                ...
                if(file_exists($filePath)) {
                    ...
                    try {
                        ...
                        $photo = $photoService->createPhoto($filePath, $name, $pathinfo['filename'], array_keys(Media_Model_Doctrine_Photo::getSlidePhotoDimensions()), false, false);
            ...
            if(file_exists($filePath)) {
                ...
                try {
                    ...
                    if(!$root || $root->isInProxyState()) {
                        ...
                        $photo = $photoService->updatePhoto($root, $filePath, null, $name, $pathinfo['filename'], array_keys(Media_Model_Doctrine_Photo::getSlidePhotoDimensions()), false);                    
                    }
    ...
    public function editSlideAction() {
        ...
        $dimensions = Media_Model_Doctrine_Photo::getSlidePhotoDimensions();
