...
class Admin_IndexController extends MF_Controller_Action
{
    ...
    public function awareAction() {
    	...
    	if(!$this->getRequest()->isXmlHttpRequest() && (($this->_moduleAware->getCalledRequest()->getControllerName() != "media") || ($this->_moduleAware->getCalledRequest()->getActionName() == 'edit-photo' || $this->_moduleAware->getCalledRequest()->getControllerName() == "media"))) {
            $this->_prepareLayout();
    	} else {
    ...
    protected function _prepareLayout() {
        ...
        $pageCount = $pageService->getAllPages(true);
        $this->view->assign('pageCount', $pageCount);
        
        $sliderCount = $sliderService->getAllSliders(true);
        $this->view->assign('sliderCount', $sliderCount);
