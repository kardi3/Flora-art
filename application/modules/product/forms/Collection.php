...
/**
 * Product_Form_Collection
 *
 * @author Tomasz Kardas <kardi31@tlen.pl>
 */
class Product_Form_Collection extends Admin_Form {
    ...
    public function init() {
        ...
        $promoted = $this->createElement('checkbox', 'promoted');
        $promoted->setLabel('Promoted');
        $promoted->setDecorators(self::$checkboxDecorators);
        $promoted->setAttrib('class', 'span8');
